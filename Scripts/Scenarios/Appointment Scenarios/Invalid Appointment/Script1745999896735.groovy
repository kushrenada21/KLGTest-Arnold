...
String facility = findTestData('appointments').getValue(1, 3)

String readmission = findTestData('appointments').getValue(2, 3)

String program = findTestData('appointments').getValue(3, 3)

String visitDate = findTestData('appointments').getValue(4, 3)

String comment = findTestData('appointments').getValue(5, 3)

String status = findTestData('appointments').getValue(6, 3)
